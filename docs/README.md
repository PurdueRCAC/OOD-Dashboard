...
|---|---|
| [Quick Start](QUICKSTART.md) | Evaluation path for a Slurm site, about an hour, touching nothing your users see |
| [Installation](INSTALLATION.md) | Requirements, deployment modes, build, and the verification checklist |
| [Configuration](CONFIGURATION.md) | Every `OOD_*` key, grouped by feature, with defaults and formats |
